...
import {Attachment} from "./azdo-attachment-service";

class LoadMobblink {
    private readonly attachmentService: AzdoAttachmentService;
    ...
    private displayAttachments(attachments: Attachment[]): void {
        const mobbLinkReport = attachments.find(attachment => attachment.name === 'mobbLinkReport.txt');
        
        const mobbButton = document.getElementById('mobbButton') as HTMLAnchorElement;
